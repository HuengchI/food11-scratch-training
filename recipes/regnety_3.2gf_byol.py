...
class RegNetYJointEngine(nn.Module):
...
def main():
    ...
    model = RegNetYJointEngine(num_classes=11).to(device)
    ema = AveragedModel(
    ...
    for epoch in range(n_epochs):
        ...
        print(f"Epoch {epoch+1:03d} | Loss CE: {epoch_loss_cls:.4f} | Loss BYOL: {epoch_loss_byol:.4f} | Train Mix ACC: {epoch_train_acc:.4f} || "
        ...
        if epoch_val_ema_acc > best_ema_acc:
            ...
            torch.save(ema.state_dict(), "best_food11_regnety_byol.pt")
